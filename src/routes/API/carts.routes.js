...
export default class CartRouter extends Router{
  ...
  init() {
    this.post('/',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.createCart)
    this.delete('/:cid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.deleteCartById)
    this.delete('/:cid/products/:pid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.deleteProdFromCart)
    this.get('/:cid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.getCartProductsById)
    this.put('/:cid/products/:pid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.updateProductCartQuantity)
    this.put('/:cid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.updateCart)
    this.post('/:cid/product/:pid',[accessRoles.ADMIN, accessRoles.USER], passportStrategiesEnum.JWT, this.addProductToCart)
    // this.get('/',[accessRoles.ADMIN, accesRoles.USER], passportStrategiesEnum.JWT, this.getAllProducts)
    // this.get('/:id',[accesRoles.ADMIN, accesRoles.USER], passportStrategiesEnum.JWT, this.getOneProductById)
  ...
  async createCart(req,res){
    ...
    try {
      const resp = await this.Cartv2.save(product_to_send)
  ...
  async getCartProductsById(req,res){
